...
export default function TechTalks({ isAdmin = false }: TechTalksProps) {
    ...
    <div>
      <div className="mb-10 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="mb-1 text-sm font-semibold uppercase tracking-widest text-blue-600">Knowledge Sharing</p>
            <h2 className="text-4xl font-extrabold text-slate-950">Tech Talks</h2>
          </div>
        </div>
